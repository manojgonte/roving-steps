    ...
    return (
        <div className="w-56 h-60 flex flex-col items-center">
            <div className="w-24 h-24 p-2 overflow-hidden">
                <Image src={"/Assets/images/common/Hexagone_2.jpg"} width={100} height={100} className="rounded-full w-full h-full object-fill" />
            </div>
            <div className="flex justify-center items-center w-full h-7">
                <span className="text-[#ECA740] font-roboto text-sm">
                    Lorem Ipsum
                </span>
            </div>
            <div className="text-center w-full h-7">
                <span className="text-[#6B6B6B] font-roboto text-sm">
